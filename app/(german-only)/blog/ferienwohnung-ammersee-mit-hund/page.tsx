        ...
        <article>
          <section className="py-20 px-6">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-[#5A5142] leading-relaxed">
          ...
          <section className="py-20 px-6">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="bg-stone border-none p-8 rounded-xl">
                  ...
                  <div className="mt-4 pt-4 border-t border-forest/10">
                    <p className="text-sm text-wood-dark font-medium">
              ...
              {/* Wichtig-Callout */}
              <div className="mt-10 bg-[#FBF6EC] border-l-4 border-wood p-6 rounded-r-xl max-w-3xl mx-auto">
                <div className="flex items-start gap-3">
                  <AlertTriangle className="w-5 h-5 text-wood-dark flex-shrink-0 mt-0.5" />
                  <p className="text-[#5A5142] leading-relaxed">
                    <strong className="text-wood-dark">Wichtig:</strong> In Naturschutzgebieten, besonders im Ampermoos am Nordende des Sees, gelten besondere Regeln zum Schutz der Vogelwelt. Achten Sie bitte auf die Beschilderung.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-20 px-6 bg-stone">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <Card className="bg-white border-none p-8 rounded-xl">
                  ...
                  <p className="text-[#5A5142] leading-relaxed mb-4">
                  ...
                  <div className="bg-wood/10 p-4 rounded-lg">
                    <p className="text-sm text-[#5A5142]">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 mt-1">
                        ...
                        <span className="text-xs bg-forest/10 text-forest px-2 py-0.5 rounded-full">Badestellen</span>
                      </div>
                    </div>
                  </div>
                  <p className="text-[#5A5142] leading-relaxed">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 mt-1">
                        ...
                        <span className="text-xs bg-forest/10 text-forest px-2 py-0.5 rounded-full">Mittel</span>
                        <span className="text-xs bg-sand text-wood-dark px-2 py-0.5 rounded-full">Leinenpflicht</span>
                      </div>
                    </div>
                  </div>
                  <p className="text-[#5A5142] leading-relaxed mb-4">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-[#5A5142] leading-relaxed text-sm">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="bg-white border-none p-6 rounded-xl">
                  ...
                  <p className="text-[#5A5142] text-sm leading-relaxed">
                ...
                <Card className="bg-white border-none p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-[#5A5142]"><strong className="text-forest">Seepromenade:</strong> Mit Blick auf den See essen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142]"><strong className="text-forest">Kloster Andechs:</strong> Hunde gehören zum Bild</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142]"><strong className="text-forest">Cafés in der Ortsmitte:</strong> Wassernäpfe bereit</span>
                    </li>
                  </ul>
                  <div className="bg-wood/10 p-3 rounded-lg mt-4">
                    <p className="text-xs text-[#5A5142]">
                ...
                <Card className="bg-white border-none p-6 rounded-xl">
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="text-wood-dark font-bold flex-shrink-0">!</span>
                      <span className="text-[#5A5142]">Bebaute Gebiete: <strong className="text-forest">Ja, immer</strong></span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-forest flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142]">Hundestrände: <strong className="text-forest">Nein</strong></span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-forest flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142]">Wald- und Feldwege: <strong className="text-forest">Nein, wenn abrufbar</strong></span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-wood-dark font-bold flex-shrink-0">!</span>
                      <span className="text-[#5A5142]">Naturschutzgebiete: <strong className="text-forest">Ja, immer</strong></span>
                    </li>
                  </ul>
                  <p className="text-xs text-[#9A8C72] mt-4">
          ...
          <section className="py-20 px-6 bg-sand">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="bg-white border-none rounded-xl overflow-hidden">
                  ...
                  <ul className="p-6 space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-[#5A5142] text-sm">EU-Heimtierausweis (für Gäste aus dem Ausland)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Impfpass mit aktueller Tollwutimpfung</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Zeckenschutz – in den bayerischen Wäldern von Frühjahr bis Herbst aktiv</span>
                    </li>
                  </ul>
                </Card>
                ...
                <Card className="bg-white border-none rounded-xl overflow-hidden">
                  ...
                  <ul className="p-6 space-y-3">
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Gewohntes Futter für die ersten Tage</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Hundenapf für Wasser und Futter</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Hundebett oder Decke – ein vertrauter Schlafplatz hilft beim Eingewöhnen</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Lieblingsspielzeug und Kauknochen</span>
                    </li>
                  </ul>
                </Card>
                ...
                <Card className="bg-white border-none rounded-xl overflow-hidden">
                  ...
                  <ul className="p-6 space-y-3">
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Leine und Geschirr – idealerweise eine kurze und eine Schleppleine</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Hundekotbeutel in ausreichender Menge</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-wood flex-shrink-0 mt-0.5" />
                      <span className="text-[#5A5142] text-sm">Handtuch für den Hund – nach dem Baden im Ammersee wird es gebraucht</span>
                    </li>
                  </ul>
                </Card>
              </div>
          ...
          <section className="py-24 px-6 bg-stone">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-[#5A5142] leading-relaxed max-w-3xl mx-auto">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-[#9A8C72] text-sm">
